    ...
    <main style={{ minWidth: '0' }}>
      ...
      <section data-plot style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.3fr) minmax(0,1fr)', gap: 'clamp(1.8rem,3vw,3rem)', marginTop: '2.6rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
          ...
          <div data-stat style={{ display: 'flex', alignItems: 'baseline', gap: '0.85rem' }}><span data-num style={{ fontFamily: '\'Saira Condensed\',sans-serif', fontSize: '2.6rem', fontWeight: '700', lineHeight: '0.9', color: '#e58d55' }}>0</span><span data-lab style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.64rem', lineHeight: '1.6', letterSpacing: '0.08em', color: '#b0a08c' }}>pages scraped — listings come from provider APIs</span></div>
          <div data-stat style={{ display: 'flex', alignItems: 'baseline', gap: '0.85rem' }}><span data-num style={{ fontFamily: '\'Saira Condensed\',sans-serif', fontSize: '2.6rem', fontWeight: '700', lineHeight: '0.9', color: '#e58d55' }}>11,500</span><span data-lab style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.64rem', lineHeight: '1.6', letterSpacing: '0.08em', color: '#b0a08c' }}>postings the scam filter was tested against</span></div>
        </div>
      </section>
