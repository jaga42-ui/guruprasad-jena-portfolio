...
<div data-screen-label="Home" style={{ position: 'relative', minHeight: '100dvh', color: '#ede4d8', background: 'transparent' }}>
  ...
  <nav aria-label="Sections" data-r="nav" style={{ position: 'fixed', right: '0.9rem', top: '50%', transform: 'translateY(-50%)', zIndex: '20', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
    ...
    <a href="/guruprasad-jena-resume.pdf" download="Guruprasad-Jena-Resume.pdf" type="application/pdf" data-r="railaction" aria-label="Download résumé (PDF)" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '0.6rem', height: '2.4rem', paddingRight: '0.85rem', transition: 'transform .3s cubic-bezier(.2,.8,.25,1)' }} className="hhv1"><span style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.6rem', fontWeight: '600', letterSpacing: '0.2em', textTransform: 'uppercase', whiteSpace: 'nowrap', color: '#e58d55', animation: 'navlabel .6s cubic-bezier(.2,.8,.25,1) 1.02s both' }}>Résumé</span><span aria-hidden="true" style={{ flex: '0 0 auto', display: 'grid', placeItems: 'center', width: '0.9rem', height: '0.9rem', animation: 'navbead .55s cubic-bezier(.2,.8,.25,1) 1.06s both' }}><svg viewBox="0 0 24 24" style={{ width: '0.78rem', height: '0.78rem', color: '#e58d55' }} fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round"><path d="M12 4v11m0 0-4-4m4 4 4-4" /><path d="M5 19h14" /></svg></span></a>
  </nav>
    ...
    <div style={{ position: 'relative', display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', gap: '3rem' }}>
      ...
      <aside style={{ position: 'relative', flex: '0 0 19rem', display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
        ...
        <div style={{ position: 'relative', padding: '2.25rem 1.25rem 1.5rem', transform: 'rotate(-2deg)', textAlign: 'center', background: 'radial-gradient(120% 100% at 50% 0%, #1e2020, #151616 58%, #101111)', border: '1px solid rgba(255,255,255,0.07)', filter: 'drop-shadow(0 1px 0.5px rgba(0,0,0,0.55)) drop-shadow(0 4px 4px rgba(0,0,0,0.3)) drop-shadow(0 10px 12px rgba(0,0,0,0.2))', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv3"><span aria-hidden="true" style={{ position: 'absolute', inset: '0', zIndex: '3', borderRadius: 'inherit', padding: '1.5px', background: 'linear-gradient(135deg,#e58d55 0%,#d080cc 34%,#7daa76 68%,#6fb8ae 100%)', WebkitMask: 'linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0)', mask: 'linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0)', WebkitMaskComposite: 'xor', maskComposite: 'exclude', filter: 'url(#sketch-edge)', opacity: '0.85', pointerEvents: 'none' }} data-ring="1"></span>
          ...
          <p style={{ margin: '0.9rem 0 0', fontFamily: '\'Playfair Display\',serif', fontSize: '1.5rem', fontWeight: '600', letterSpacing: '-0.01em', color: '#f5efe7' }}>Guruprasad Jena</p>
      ...
      <div style={{ position: 'relative', flex: '1 1 min(100%,28rem)', minWidth: '0' }}>
        ...
        <p style={{ margin: '0.9rem 0 0', fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.8rem', fontWeight: '700', letterSpacing: '0.32em', color: '#e58d55' }} data-motion="kicker">FULL-STACK DEVELOPER</p>

        <p style={{ margin: '0.8rem 0 0', maxWidth: '34rem', fontFamily: '\'Playfair Display\',serif', fontStyle: 'italic', fontSize: '1.24rem', lineHeight: '1.5', color: '#ded1be' }} data-motion="line">I build products end to end — ingestion pipelines that pull from real provider APIs, backends that hold up under duplicates and retries, and interfaces people actually finish using. <span style={{ fontStyle: 'normal', fontWeight: '600', color: '#e58d55' }}>Four are live.</span></p>

        <p style={{ margin: '0.9rem 0 0', fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.72rem', lineHeight: '1.9', color: '#8fae88' }} data-motion="line"><span style={{ color: '#7daa76' }}>$</span> stack <span style={{ color: '#6b6252' }}>—</span> <span style={{ color: '#ccbba8' }}>TypeScript · Next.js · React · Node.js · MongoDB · Redis · REST APIs · LLM tooling</span></p>

        <nav aria-label="Primary" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.6rem 1.3rem', marginTop: '1.25rem' }} data-motion="line">
          <a href="/projects" style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.74rem', fontWeight: '700', letterSpacing: '0.16em', color: '#e58d55', borderBottom: '1px solid rgba(229,141,85,0.5)', paddingBottom: '0.18rem', transition: 'color .2s ease,border-color .2s ease' }} className="hhv8">VIEW PROJECTS <span aria-hidden="true">→</span></a>
          <a href="https://github.com/jaga42-ui" target="_blank" rel="noopener" style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.72rem', fontWeight: '500', letterSpacing: '0.16em', color: '#ccbba8', transition: 'color .2s ease' }} className="hhv9">GITHUB</a>
          <a href="/guruprasad-jena-resume.pdf" download="Guruprasad-Jena-Resume.pdf" type="application/pdf" style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.72rem', fontWeight: '500', letterSpacing: '0.16em', color: '#ccbba8', transition: 'color .2s ease' }} className="hhv9">RÉSUMÉ</a>
          <a href="https://www.linkedin.com/in/guruprasad-jena" target="_blank" rel="noopener" style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.72rem', fontWeight: '500', letterSpacing: '0.16em', color: '#ccbba8', transition: 'color .2s ease' }} className="hhv9">LINKEDIN</a>
          <a href="/contact" style={{ fontFamily: '\'JetBrains Mono\',monospace', fontSize: '0.72rem', fontWeight: '500', letterSpacing: '0.16em', color: '#ccbba8', transition: 'color .2s ease' }} className="hhv9">CONTACT</a>
        </nav>
        ...
        <div style={{ position: 'relative', display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', gap: '1.75rem', marginTop: '2.25rem' }}>
          ...
          <div style={{ position: 'relative', width: '14rem', transform: 'rotate(-3deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv10">
          ...
          <div style={{ position: 'relative', width: '17rem', transform: 'rotate(2deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv11">
          ...
          <div style={{ position: 'relative', width: '13.5rem', transform: 'rotate(6deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv12">
        ...
        <div style={{ position: 'relative', display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', gap: '2rem', marginTop: '4.5rem' }}>
          <div style={{ position: 'relative', flex: '0 1 auto', maxWidth: '100%', transform: 'rotate(-3deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv10">
          ...
          <div style={{ position: 'relative', width: '13rem', transform: 'rotate(5deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv13">
        ...
        <div style={{ position: 'relative', display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', gap: '1.5rem', marginTop: '3rem' }}>
          <div style={{ position: 'absolute', top: '-3rem', right: '6rem', zIndex: '20', transform: 'rotate(-6deg)', padding: '0.5rem 0.75rem', background: 'linear-gradient(180deg,#e8b64a,#cf9a2e)', boxShadow: '0 2px 3px rgba(0,0,0,0.6), 0 10px 16px -4px rgba(0,0,0,0.55)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="tag" className="hhv14">
          ...
          <div style={{ position: 'relative', flex: '1 1 min(100%,22rem)', maxWidth: 'min(100%,32rem)', transform: 'rotate(-1deg)', transition: 'transform .26s cubic-bezier(.2,.8,.25,1)' }} data-motion="scrap" className="hhv15">
